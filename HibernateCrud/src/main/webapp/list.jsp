<%@page import="com.example.employeecrud.model.*"%>
...
<body>
	...
	if (request.getAttribute("obj") != null) {
		Employee std = (Employee) request.getAttribute("obj");
	%>
	<form action="UpdateController" method="post">
		...
		<input type="text" placeholder="Enter Marks" name="marks" value="<%= std.getSalary() %>"> <br><br>
